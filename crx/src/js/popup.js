...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector("#program-loader").addEventListener("click", () => {
        ...
        setTimeout(() => {
            chrome.storage.local.get(["codeForLogic"], function (items) {
    ...
    function getSpec(path, successMessage) {
        ...
        try {
            import("pyret-parse").then((module) => {
                console.log("Loaded pyret-parse");
                console.log(correctParsedOutput.instructor);
                console.log(correctParsedOutput.student);
                const content = module.parse(
                    correctParsedOutput.instructor,
                    correctParsedOutput.student
                );
